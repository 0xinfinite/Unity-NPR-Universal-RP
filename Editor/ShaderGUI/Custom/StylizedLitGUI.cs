...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    ...
    public static class StylizedLitGUI
    {
        ...
        public struct LitProperties
        {
            ...
            public MaterialProperty giAdditive;
            ...
            public LitProperties(MaterialProperty[] properties)
            {
                ...
                giAdditive = BaseShaderGUI.FindProperty("_GIAdditive", properties, false);
        ...
        public static void DrawStylizedArea(LitProperties properties, MaterialEditor materialEditor, Material material)
        {
            ...
            //else
            {
                ...
                materialEditor.ColorProperty(properties.shadowColor, "Shadow Tint");
        ...
        public static void SetMaterialKeywords(Material material)
        {
            ...
            CoreUtils.SetKeyword(material, "_WARPMAP", hasWarpMap);

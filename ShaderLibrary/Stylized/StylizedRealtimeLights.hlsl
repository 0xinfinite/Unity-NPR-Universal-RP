...
////#endif
//
////struct StylizedLight {
////    Light light;
////    half distanceAttenuationOffset;
////};
//
////Light GetAdditionalPerObjectStylizedLight(int perObjectLightIndex, float3 positionWS) {
////    Light normalLight = GetAdditionalPerObjectLight(perObjectLightIndex, positionWS);
////
////    StylizedLight stylizedLight = (StylizedLight)0;
////
////    stylizedLight.light = normalLight;
////#if USE_STRUCTURED_BUFFER_FOR_LIGHT_DATA
////    stylizedLight.distanceAttenuationOffset = _AdditionalLightsBuffer[perObjectLightIndex].distanceAttenuationOffset;
////#else
////    stylizedLight.distanceAttenuationOffset = _AdditionalLightDistanceAttenuationOffset[perObjectLightIndex];
////#endif
////}
//
/////////////////////////////////////////////////////////////////////////////////
...
////}
//
//half GetAdditionalLightDistanceAttenuationOffset(uint i) {
//#if USE_FORWARD_PLUS
//    int lightIndex = i;
//#else
//    int lightIndex = GetPerObjectLightIndex(i);
...
//
//#if USE_STRUCTURED_BUFFER_FOR_LIGHT_DATA
//    return _AdditionalLightsBuffer[lightIndex].distanceAttenuationOffset;
//#else
//    return _AdditionalLightDistanceAttenuationOffset[lightIndex];
//#endif
//}
//
...
//    int lightIndex = GetPerObjectLightIndex(i);
//#endif
//    Light light = GetAdditionalPerObjectLight(lightIndex, positionWS);//GetStylizedAdditionalPerObjectLight(lightIndex, positionWS);
//
//#if USE_STRUCTURED_BUFFER_FOR_LIGHT_DATA
